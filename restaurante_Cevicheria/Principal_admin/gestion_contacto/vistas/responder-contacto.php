...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="respuestaForm" method="post" action="/restaurante_Cevicheria/controller/responder-contacto.php">
                    <input hidden type="text" value="<?=$reclamo[0]['id'] ?? '' ?>" name="id">
                    <input hidden type="text" id="estadoInput" value="Pendiente" name="estado">

                    <div class="form-group">
                        <label for="nombres"><i class="fas fa-envelope"></i> Nombres</label>
                        <input type="text" class="form-control" id="nombres" value="<?=$reclamo[0]['nombre'] ?? '' ?>" name="nombres" readonly>
                    </div>

                    <div class="form-group">
                        <label for="apellidos"><i class="fas fa-envelope"></i> Apellidos</label>
                        <input type="text" class="form-control" id="apellidos" value="<?=$reclamo[0]['apellidos'] ?? '' ?>" name="apellidos" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="mensaje" name="descripcion" rows="4" readonly><?=$reclamo[0]['mensaje'] ?? '' ?></textarea>
                    </div>
